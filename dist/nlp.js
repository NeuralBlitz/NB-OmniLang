...
export class NLPEngine {
  customIntents = /* @__PURE__ */ new Map();
  customEntities = /* @__PURE__ */ new Map();
  dslPatterns = /* @__PURE__ */ new Map();
  contextHistory = [];
...
\`\`\``;
  ...
  processMultiStep(input, multiStep) {
    ...
    const codeFences = stepResults.map((r, i) => r.code ? `
